...
#define GTA_isPauseMenuActive						0xB7CB49
#define GTA_isGameActive_OFFSET						0x3023C // DINPUT8.dll + 0x3023C
...
void											addClientCommand(const char *text, CMDPROC function);
void											addToChatWindow(std::string text, D3DCOLOR textColor, int playerID = -1);
...
uint8_t											hook_handle_dialog_response(void);
